...
st.caption(
    "Conformational ensemble analysis · macrocycles · PROTACs · bRo5 compounds · Rgyr · 3D-PSA · IMHB · π–π stacking"
)
...
""", unsafe_allow_html=True)
st.markdown(
    "Upload one or more multi-conformer **MOL2** files for any bRo5 molecule class "
    "(macrocycles, PROTACs, cyclic peptides, or other large flexible scaffolds). "
