...
<div class="param-grid">
    ...
    <div class="param-card">
        ...
        <div class="param-desc">
            ...
            Contacts whose shortest covalent D→A path traverses any ring bond are
            automatically excluded: such proximity is locked by the ring framework
            and does not represent a conformationally driven interaction.
        </div>
    </div>
    <div class="param-card">
        <div class="badge optional">Optional</div>
